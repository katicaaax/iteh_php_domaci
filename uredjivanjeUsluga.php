...
if (isset($_POST['usluga_naziv'])) {
    ...
    $usluga->setKozmeticki_salon_id($_POST['kozmeticki_salon_id']);
        ...
        <script>
            ...
            $.get("kontroler.php", {kozmeticki_salon: "prikaz"})
                    .done(function (data) {
                        ...
                        var podaci = JSON.parse(data);
                        for (var i = 0; i < podaci.length; i++) {
                            ispis += '<option  value=' + podaci[i].kozmeticki_salon_id + '>' + podaci[i].kozmeticki_salon_naziv + '</option>';
                        }
                        ;
                        $('#servisi').html(ispis);
                    });
        ...
        <div id="content_left">
            ...
            <div class="box">
                ...
                <form class="form-group"  action="" method="POST" name="unos" >
                    ...
                    <select class="form-control" id="servisi" name="kozmeticki_salon_id">
                    </select>
                    <p>Opis</p>
